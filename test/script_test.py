...
PROG_TEST = "../utils/rms"
PROG = "./vorbis_decoder"
MODULES = ["residue","codebook","mode","main","vorbis_main","vorbis_io","vorbis_packet","headers","dot_product","pcm_handler","floor","floor1","mapping","time_transform","helpers","envelope"]
