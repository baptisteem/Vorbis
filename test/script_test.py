...
PROG_TEST = "../utils/rms"
PROG = "./vorbis_decoder"
MODULES = ["residue","codebook","mode","ogg_core","main","vorbis_main","vorbis_io","vorbis_packet","headers","dot_product","pcm_handler","floor","floor1","mapping","time_domain","helpers","envelope"]
